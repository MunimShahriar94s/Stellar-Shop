...
const OAuthTest = () => {
  return (
    <Container>
      ...
      <ButtonContainer>
        <GoogleButton href={`${import.meta?.env?.VITE_BACKEND_ORIGIN || ''}/auth/google`}>
      ...
      <FormContainer>
        <Form action={`${import.meta?.env?.VITE_BACKEND_ORIGIN || ''}/auth/google`} method="get">
      ...
      <DirectLinkContainer>
        <DirectLink 
          ...
          onClick={(e) => {
            e.preventDefault();
            window.location.href = `${import.meta?.env?.VITE_BACKEND_ORIGIN || ''}/auth/google`;
          }}
        >
