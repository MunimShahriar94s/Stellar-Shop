      ...
      <HeaderRight>
        ...
        <UserProfile onClick={() => setDropdownOpen(!dropdownOpen)}>
          ...
          <UserInfo>
            ...
            <UserRole>{user?.role === 'admin' ? 'Administrator' : 'User'}</UserRole>
          </UserInfo>
          <DropdownMenu isOpen={dropdownOpen}>
            ...
            <MenuItem as="button" onClick={handleLogout} style={{ background: 'none', border: 'none', width: '100%', textAlign: 'left', cursor: 'pointer' }}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
